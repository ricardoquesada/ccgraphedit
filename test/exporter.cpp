...
bool Exporter::ExportToStream(Stream& stream)
{
...
bool Exporter::ExportNodeBegin(Stream& stream, NodeItem* item)
{
...
bool Exporter::ExportNodeEnd(Stream& stream, NodeItem* item)
{
    return true;
}
